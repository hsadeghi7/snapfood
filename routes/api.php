...
Route::middleware('auth:sanctum')->prefix('buyer')->group(function(){
    ...
    Route::get('/buyer/carts', [CartController::class, 'index']);
    Route::post('/buyer/carts', [CartController::class, 'store']);
    Route::put('/buyer/carts/{cart}', [CartController::class, 'update']);
    Route::delete('/buyer/carts/{cart}', [CartController::class, 'delete']);
